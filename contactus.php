            ...
            <div class="content">
                <div class="left-side">
                    ...
                    <div class="phone details">
                        ...
                        <div class="text-one">9570885984</div>
                        <div class="text-two">8340650161</div>
                    </div>
                    <div class="email details">
                        <i class="fas fa-envelope"></i>
                        <div class="topic">Email</div>
                        <div class="text-one">tariqueansari1020@gmail.com</div>
                        <div class="text-two">info.tariqueansari9570@gmail.com</div>
                    </div>
                </div>
                <div class="right-side">
                    ...
                    <form action="contactus.php">
                        ...
                        <div class="input-box message-box">
                            <input type="text" name="detail" placeholder="Enter your message">
